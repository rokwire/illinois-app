...
class Game with Explore, DisplayDateTime implements Favorite {
  final String? id;
  ...
  ////////////////////////////
  // DisplayDate implementation

  @override DateTime? get startDateTimeUtcValue => dateTimeUtc;
  @override DateTime? get endDateTimeUtcValue => endDateTimeUtc;
