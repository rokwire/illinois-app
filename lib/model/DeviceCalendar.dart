...
class DeviceCalendarEvent extends rokwire.DeviceCalendarEvent {
  ...
  factory DeviceCalendarEvent.fromEvent2(Event2 event) => DeviceCalendarEvent(
    ...
    startDate: AppDateTime().getDeviceTimeFromUtcTime(event.startTimeUtc),
    endDate: AppDateTime().getDeviceTimeFromUtcTime(event.endTimeUtc),
  ...
  factory DeviceCalendarEvent.fromGame(Game game) => DeviceCalendarEvent(
    ...
    startDate: AppDateTime().getDeviceTimeFromUtcTime(game.dateTimeUtc),
    endDate:  AppDateTime().getDeviceTimeFromUtcTime(game.endDateTimeUtc),
  ...
  factory DeviceCalendarEvent.fromAppointment(Appointment appointment) {
    DateTime? calendarEventStartDateTime = AppDateTime().getDeviceTimeFromUtcTime(appointment.startTimeUtc);
  ...
  factory DeviceCalendarEvent.fromCanvasCalendarEvent(CanvasCalendarEvent event) => DeviceCalendarEvent(
    ...
    startDate: AppDateTime().getDeviceTimeFromUtcTime(event.startAt),
    endDate: AppDateTime().getDeviceTimeFromUtcTime(event.endAt),
