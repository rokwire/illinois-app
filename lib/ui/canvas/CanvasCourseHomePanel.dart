...
import 'package:neom/ui/canvas/CanvasAccountNotificationsPanel.dart';
import 'package:neom/ui/canvas/CanvasCourseAnnouncementsPanel.dart';
import 'package:neom/ui/canvas/CanvasCourseAssignmentsPanel.dart';
import 'package:neom/ui/canvas/CanvasCourseCalendarPanel.dart';
import 'package:neom/ui/canvas/CanvasCourseCollaborationsPanel.dart';
import 'package:neom/ui/canvas/CanvasCourseModulesPanel.dart';
import 'package:neom/ui/canvas/CanvasFeedbackPanel.dart';
import 'package:neom/ui/canvas/CanvasFileSystemEntitiesListPanel.dart';
import 'package:neom/ui/canvas/CanvasSyllabusHtmlPanel.dart';
...
class _CanvasCourseHomePanelState extends State<CanvasCourseHomePanel> {
  ...
  Widget _buildCourseContent() {
    return SingleChildScrollView(
        ...
        child:
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [CanvasCourseCard(course: _course!, embedded: true), _buildButtonsContent()]));
  }
