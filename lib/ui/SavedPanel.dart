    ...
    return Padding(padding: EdgeInsets.symmetric(horizontal: 48, vertical: 32), child:
      Column(children: <Widget>[
        ...
        (favoriteCategory != null) ?
            ...
            : Text(Localization().getStringEx("panel.saved.message.no_items.description", "Tap the \u2606 on events, dining locations, and reminders that interest you to quickly find them here. (Your privacy level must be at least 3.)"), style: Styles().textStyles.getTextStyle("widget.item.regular.thin"),),
        Expanded(child: Container(), flex: 3),
    ],),);
  }
