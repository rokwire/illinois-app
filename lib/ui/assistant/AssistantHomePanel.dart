  ...
  Widget build(BuildContext context) {
    String text = Assistant().localizedTermsText ??
        Localization().getStringEx('panel.assistant.terms.default.msg',
            'The NEOM U Assistant is a search tool that helps you learn more about official university resources. While the feature aims to provide useful information, responses may occasionally be incomplete or inaccurate. **You are responsible for confirming information before taking action based on it.**\n\nBy continuing, you acknowledge that the NEOM U Assistant is a supplemental tool and not a substitute for official university sources.');
    return AlertDialog(
        contentPadding: EdgeInsets.zero,
        content: Container(
            decoration: BoxDecoration(color: Styles().colors.surface, borderRadius: BorderRadius.circular(10.0)),
