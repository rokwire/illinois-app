...
class _MTDStopScheduleCardState extends State<MTDStopScheduleCard> implements NotificationsListener {
  ...
  Widget build(BuildContext context) {
    ...
    Color? cardDetailTextColor = widget.stop.favoriteDetailTextColor ?? AppColors.textBackground;
  ...
  Widget _buildDeparturesList() {
    ...
    for (int index = 0; index < departuresCount; index++) {
      ...
      if (contentList.isNotEmpty) {
        contentList.add(Divider(height: 1, color: AppColors.fillColorPrimaryTransparent03,));
      }
      ...
      Row(children: [
        Container(width: circleSize, height: circleSize,
          decoration: BoxDecoration(
            ...
            border: Border.all(color: AppColors.surfaceAccentTransparent15, width: 1),
