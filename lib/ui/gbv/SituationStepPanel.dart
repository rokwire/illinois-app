...
// Helper to set filtered results from resource ids and show the survey_data.result panel
  void _setFilteredResults(List<String> resourceIds) {
    // For Q4 specific resource sets B/C/D, get the SurveyData from surveyData map by keys:
    // But since we only have resourceids directly here, we create a dummy SurveyData for filtering
    ...
    // For explicit sets B, C, D handle separately by their keys to get SurveyData for header text etc.
