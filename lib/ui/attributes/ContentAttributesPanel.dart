    ...
    return Padding(padding: EdgeInsets.only(top: 16), child:
      Row(children: <Widget>[
        ...
        Expanded(flex: 2, child: RoundedButton(
          ...
          textColor: _canApply ? Styles().colors.fillColorPrimary : Styles().colors.surfaceAccent,
          borderColor: _canApply ? Styles().colors.fillColorSecondary : Styles().colors.surfaceAccent,
          backgroundColor: Styles().colors.white,
          textStyle: Styles().textStyles.getTextStyle(_canApply ? 'widget.button.title.medium.fat' : 'widget.button.title.medium.fat.variant3'),
