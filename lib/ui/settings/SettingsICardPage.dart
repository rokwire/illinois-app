              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Padding(
                    ...
                    child: ToggleRibbonButton(
                        title: Localization().getStringEx('panel.settings.icard.play_sound.button', 'Play sound when unlocking'),
                ...
                Padding(
                    ...
                    child: ToggleRibbonButton(
                        title: Localization().getStringEx('panel.settings.icard.vibrate.button', 'Vibrate when unlocking'),
