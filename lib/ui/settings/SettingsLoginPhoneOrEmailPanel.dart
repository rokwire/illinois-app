  ...
  void _onPhoneInitiated(String? phoneNumber, Auth2RequestCodeResult result) {
    if (mounted) {
      ...
      if (result == Auth2RequestCodeResult.succeeded) {
        Navigator.push(context, CupertinoPageRoute(builder: (context) => SettingsLoginCodePanel(identifier: phoneNumber, linkIdentifier: widget.link, onFinish: widget.onFinish)));
