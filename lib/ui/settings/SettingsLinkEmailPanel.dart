...
class _SettingsLinkEmailPanelState extends State<SettingsLinkEmailPanel>  {
  ...
  Auth2EmailAccountState? _state = Auth2EmailAccountState.nonExistent;
  ...
  Widget build(BuildContext context) {
    String title = (_state == Auth2EmailAccountState.nonExistent) ?
      Localization().getStringEx('panel.settings.link.email.label.title', 'Add Email Address') :
    ...
    String description = (_state == Auth2EmailAccountState.nonExistent) ?
      Localization().getStringEx('panel.onboarding2.email.link.description.text', 'Please enter a password to add your email address.') :
    ...
    String buttonTitle = (_state == Auth2EmailAccountState.nonExistent) ?
      Localization().getStringEx('panel.onboarding2.email.button.link.text', 'Add') :
    ...
    String buttonHint = (_state == Auth2EmailAccountState.nonExistent) ?
      Localization().getStringEx('panel.onboarding2.email.button.link.hint', '') :
