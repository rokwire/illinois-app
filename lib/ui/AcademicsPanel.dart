...
class _AcademicsPanelState extends State<AcademicsPanel> with AutomaticKeepAliveClientMixin<AcademicsPanel> implements NotificationsListener {
  ...
  Widget _buildHeaderTitle() {
    return Semantics(label: Localization().getStringEx('panel.academics.header.title', 'Academics'), excludeSemantics: true, child:
      Text(Localization().getStringEx('panel.academics.header.title', 'Academics'), style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w900, letterSpacing: 1.0),),);
  }
