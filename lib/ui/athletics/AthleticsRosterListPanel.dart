                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: (StringUtils.isNotEmpty(roster.thumbPhotoUrl) ?
                      ModalImageHolder(imageUrl: Config().wrapWebProxyUrl(sourceUrl: roster.fullSizePhotoUrl), child: Image.network(Config().wrapWebProxyUrl(sourceUrl: roster.fullSizePhotoUrl) ?? '', headers: Auth2Csrf().networkAuthHeaders, semanticLabel: "roster", width: _photoWidth, fit: BoxFit.cover, alignment: Alignment.topCenter,)) :
