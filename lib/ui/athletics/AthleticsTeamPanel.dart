...
import 'package:neom/model/sport/Coach.dart';
...
import 'package:neom/ui/athletics/AthleticsNewsCard.dart';
import 'package:rokwire_plugin/ui/widgets/rounded_button.dart';
import 'package:neom/ui/athletics/AthleticsSchedulePanel.dart';
import 'package:neom/ui/athletics/AthleticsNewsListPanel.dart';
...
import 'package:neom/ui/athletics/AthleticsCoachDetailPanel.dart';
import 'package:neom/ui/athletics/AthleticsCoachListPanel.dart';
import 'package:neom/ui/athletics/AthleticsScheduleCard.dart';
...
class _AthleticsTeamPanelState extends State<AthleticsTeamPanel> implements NotificationsListener {
        ...
        Container(
            ...
            child: Column(children: <Widget>[
              Container(
                  color: Colors.white,
                  child: Padding(
                      padding: EdgeInsets.only(left: 24, top: 12, right: 24, bottom: 24),
                      child: Row(
                          ...
                          children: <Widget>[
                            Expanded(
                                child:
                                    Text(widget.sport!.name!, maxLines: 2, style: Styles().textStyles.getTextStyle("widget.title.huge"))),
                            Container(width: 24),
                            Semantics(
                                ...
                                child: GestureDetector(
                                    ...
                                    child: Padding(
                                        ...
                                        child: Styles().images.getImage(
                                            hasSportPreference ? 'check-circle-filled' : 'check-circle-outline-gray',
                      ...
                      Padding(
                          ...
                          child: Semantics(
                              ...
                              child: Row(children: <Widget>[
                                ...
                                Text(Localization().getStringEx("panel.athletics_team.label.schedule.title", 'Schedule'),
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                if (_games != null && _games!.length > 0) {
                                  ...
                                  return AthleticsScheduleCard(game: game);
                                } else {
                                  return Container();
                                }
                              },
                      ...
                      child: Padding(
                          ...
                          child: Semantics(
                              ...
                              child: Row(children: <Widget>[
                                ...
                                Text(Localization().getStringEx("panel.athletics_team.button.news.title", 'News'),
                                    style: Styles().textStyles.getTextStyle("widget.title.light.large"))
                              ])))),
                  Padding(padding: EdgeInsets.only(bottom: 26), child: _buildNewsList()),
                  Padding(
                      padding: EdgeInsets.only(bottom: 48, left: 10, right: 10),
                      child: Row(children: <Widget>[
                            ...
                            child: RoundedButton(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.push(
                                      context,
                                      CupertinoPageRoute(
                                          builder: (context) => AthleticsNewsListPanel(
                  ...
                  child: Stack(alignment: Alignment.topCenter, children: <Widget>[
                    Container(
                        ...
                        child: Padding(
                            ...
                            child: Text(Localization().getStringEx("panel.athletics_team.label.team_roster.title", 'Team Roster'),
                                style: Styles().textStyles.getTextStyle("widget.title.large")))),
                    Padding(
                        padding: EdgeInsets.only(left: 16, top: 52, bottom: 32),
                        child: SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: _buildTeamRoster())))
                  ])),
              Visibility(
                  visible: CollectionUtils.isNotEmpty(_allRosters),
                  child: Padding(
              ...
              Visibility(
                  ...
                  child: Stack(alignment: Alignment.topCenter, children: <Widget>[
                    ...
                    Padding(
                        ...
                        child: SingleChildScrollView(
                            scrollDirection: Axis.horizontal,
                            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: _buildCoachingStaff())))
                  ])),
              Visibility(
                  visible: CollectionUtils.isNotEmpty(_allCoaches),
                  child: Padding(
              ...
              Padding(
                  ...
                  child: Text(followLabel, style: Styles().textStyles.getTextStyle("widget.item.large"))),
              Stack(alignment: Alignment.topCenter, children: <Widget>[
                Padding(
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: <Widget>[
                  Semantics(
                      ...
                      button: true,
                      excludeSemantics: true,
                      child: _TeamSocialCell(name: "Facebook", iconKey: 'facebook-logo', webUrl: facebookPageUrl)),
                  Semantics(
                      ...
                      button: true,
                      excludeSemantics: true,
                      child: _TeamSocialCell(name: "Twitter", iconKey: 'twitter-logo', webUrl: twitterUrl)),
                  Semantics(
                      ...
                      button: true,
                      excludeSemantics: true,
                      child: _TeamSocialCell(name: "YouTube", iconKey: 'youtube-logo', webUrl: Config().youtubeUrl)),
                  Semantics(
                      ...
                      button: true,
                      excludeSemantics: true,
                      child: _TeamSocialCell(name: "Instagram", iconKey: 'instagram-logo', webUrl: instagramUrl))
                ])
              ])
            ]))
      ]))
    ...
    return CollectionUtils.isNotEmpty(_teamNews)
        ? ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return ((index == 0) && StringUtils.isNotEmpty(news.imageUrl))
                  ? ImageSlantHeader(
  ...
  GestureTapCallback _showRosterListPanel() {
    return () {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) => AthleticsRosterListPanel(widget.sport, _allRosters)));
    };
  }
  ...
  GestureTapCallback _showCoachListPanel() {
    return () {
      ...
      Navigator.push(context, CupertinoPageRoute(builder: (context) => AthleticsCoachListPanel(widget.sport, _allCoaches)));
    };
  }
  ...
  GestureTapCallback _showScheduleListPanel() {
    return () {
      ...
      Navigator.push(
          context,
          CupertinoPageRoute(
              builder: (context) => AthleticsSchedulePanel(
                    sport: widget.sport,
                  )));
    };
  }
  ...
  void _onTapRosterItem(BuildContext context, Roster roster) {
    ...
    Navigator.push(context, CupertinoPageRoute(builder: (context) => AthleticsRosterDetailPanel(widget.sport, roster)));
  }

  void _onTapCoachItem(BuildContext context, Coach coach) {
    Analytics().logSelect(target: "Coach: " + coach.title!);
    Navigator.push(context, CupertinoPageRoute(builder: (context) => AthleticsCoachDetailPanel(widget.sport, coach)));
  }
  ...
  List<Widget> _buildTeamRoster() {
    ...
    if (_allRosters != null) {
      for (Roster roster in _allRosters!) {
        ...
        rosterWidgets.add(_RosterItem(
            name: roster.name, position: roster.position, imageUrl: roster.thumbPhotoUrl, onTap: () => _onTapRosterItem(context, roster)));
      }
    }
  ...
  List<Widget> _buildCoachingStaff() {
    ...
    if (_allCoaches != null) {
      for (Coach coach in _allCoaches!) {
        ...
        coachingWidgets.add(_RosterItem(
            name: coach.name, position: coach.title, imageUrl: coach.thumbPhotoUrl, onTap: () => _onTapCoachItem(context, coach)));
      }
    }
    ...
    return Semantics(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
            ...
            Padding(
                padding: EdgeInsets.only(top: 6), child: Text(result!, style: Styles().textStyles.getTextStyle("widget.title.extra_large")))
          ])
        ]));
  }
}
...
class _RosterItem extends StatelessWidget {
  ...
  _RosterItem({required this.name, required this.position, this.imageUrl, this.onTap});
        ...
        child: Padding(
            ...
            child: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                  ClipRRect(borderRadius: BorderRadius.circular(10), child: _imageContainer()),
                  Container(height: 12),
                  Text(name!, style: Styles().textStyles.getTextStyle("widget.title.regular.fat")),
                  Text(StringUtils.ensureNotEmpty(position), softWrap: true, style: Styles().textStyles.getTextStyle("widget.item.regular"))
                ]))));
  }
