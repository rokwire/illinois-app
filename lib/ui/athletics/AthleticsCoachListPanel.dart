              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    ModalImageHolder(url: Config().wrapWebProxyUrl(sourceUrl: coach.fullSizePhotoUrl), child: Image.network(Config().wrapWebProxyUrl(sourceUrl: coach.fullSizePhotoUrl) ?? '', headers: Auth2Csrf().networkAuthHeaders, semanticLabel: "coach", width: _photoWidth, fit: BoxFit.cover, alignment: Alignment.topCenter,)):
