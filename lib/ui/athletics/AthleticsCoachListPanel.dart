              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    ModalImageHolder(url: Config().wrapWebProxyUrl(sourceUrl: coach.fullSizePhotoUrl), child: WebNetworkImage(imageUrl: coach.fullSizePhotoUrl!, semanticLabel: "coach", width: _photoWidth, fit: BoxFit.cover, alignment: Alignment.topCenter,)):
