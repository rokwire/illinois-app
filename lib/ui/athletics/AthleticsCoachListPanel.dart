              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    ModalImageHolder(imageUrl: coach.fullSizePhotoUrl, headers: Auth2().networkAuthHeaders, child: Image.network(coach.thumbPhotoUrl!, headers: Auth2().networkAuthHeaders, semanticLabel: "coach", width: _photoWidth, fit: BoxFit.cover, alignment: Alignment.topCenter,)):
