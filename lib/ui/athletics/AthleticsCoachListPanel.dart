                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: (StringUtils.isNotEmpty(coach.thumbPhotoUrl) ?
                      AccessibleImageHolder(child: ModalImageHolder(imageUrl: coach.fullSizePhotoUrl, child: WebNetworkImage(imageUrl: coach.fullSizePhotoUrl, headers: Auth2().networkAuthHeaders, semanticLabel: "coach", width: _photoWidth, fit: BoxFit.cover, alignment: Alignment.topCenter, errorBuilder: (context, error, stackTrace) => _defaultPhotoWidget))):
                      _defaultPhotoWidget),
                  ),
                ),
              ],
