                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Padding(
                                      ...
                                      child: Text(
                                        Localization().getStringEx("panel.athletics.label.all_illinois_sports.title",'All {{app_title}} Sports').replaceAll('{{app_title}}', Localization().getStringEx('app.title', 'Illinois')),
