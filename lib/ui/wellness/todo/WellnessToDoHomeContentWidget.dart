    ...
    return Stack(alignment: Alignment.center, children: [
      Container(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Semantics(label: "Edit", button: true, child: InkWell(onTap: () => _onTapEdit(widget.item), child: Padding(padding: EdgeInsets.symmetric(horizontal: 15, vertical: 10), child: Image.asset('images/edit-white.png', excludeFromSemantics: true))))
          ])),
