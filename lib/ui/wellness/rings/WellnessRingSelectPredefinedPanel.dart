...
class _WellnessRingSelectPredefinedPanelState extends State<WellnessRingSelectPredefinedPanel> implements NotificationsListener{
  static const List<Map<String,dynamic>> PREDEFINED_RING_BUTTONS = [
    {"ring":{'name': "Hobby", 'value': 2, 'color_hex': '#f5821e', 'id': "id_predefined_0", 'unit':'session'},
      "name":"Hobby Ring",
    ...
    {"ring":{'name': "Movement", 'value': 2, 'color_hex': '#54a747', 'id': "id_predefined_1", 'unit':'activity'},
      "name":"Movement Ring",
    ...
    {"ring":{'name': "Mindfulness", 'value': 2, 'color_hex': '#09fd4' , 'id': "id_predefined_2", 'unit':'moment'},
      "name":"Mindfulness",
