  ...
  Future<void> _onTapShareLink() async {
    ...
    if (_deepLinkUri?.isValid == true) {
      try {
        ...
        message = Localization().getStringEx('panel.qr_code.alert.share.failed.msg', 'Failed to share $_shareReasonMacro.').replaceAll(_shareReasonMacro, _shareQrCodeTarget);
