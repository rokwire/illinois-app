    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if (widget.background != null) {
          ...
          final double titleOffset = widget.title == null ? widget.titleOffset : 0;
        ...
        if (widget.title != null) {
          ...
          if (opacity > 0.0) {
            children.add(Container(color: widget.color ??
                theme.appBarTheme.backgroundColor, height: settings.minExtent));
