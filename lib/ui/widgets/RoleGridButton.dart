  ...
  static RoleGridButton? fromRole(UserRole? role, { bool? selected, double? sortOrder, void Function(RoleGridButton)? onTap }) {
    if (role == UserRole.student) {
      return RoleGridButton(
        ...
        selectedIconAsset:  'images/icon-persona-student-normal.png',
      ...
      return RoleGridButton(
        ...
        selectedIconAsset:  'images/icon-persona-visitor-normal.png',
        selectedBackgroundColor: Styles().colors!.white,
        selected: (selected == true),
        data: role,
        sortOrder: sortOrder,
      ...
      return RoleGridButton(
        ...
        selectedIconAsset:  'images/icon-persona-athletics-normal.png',
        selectedBackgroundColor: Styles().colors!.white,
        selected: (selected == true),
        data: role,
        sortOrder: sortOrder,
      ...
      return RoleGridButton(
        ...
        selectedIconAsset: 'images/icon-persona-employee-normal.png',
        selectedBackgroundColor: Styles().colors!.white,
        selected: (selected == true),
        data: role,
        sortOrder: sortOrder,
      ...
      return RoleGridButton(
        ...
        selectedIconAsset: 'images/icon-persona-alumni-normal.png',
        selectedBackgroundColor: Styles().colors!.white,
        selected:(selected == true),
        data: role,
        sortOrder: sortOrder,
      ...
      return RoleGridButton(
        ...
        selectedIconAsset:  'images/icon-persona-parent-normal.png',
        selectedBackgroundColor: Styles().colors!.white,
        selected: (selected == true),
        data: role,
        sortOrder: sortOrder,
