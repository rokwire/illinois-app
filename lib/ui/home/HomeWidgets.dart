            ...
            Expanded(child:
              Padding(padding: EdgeInsets.symmetric(vertical: 12), child:
                Semantics(label: widget.title, header: true, excludeSemantics: true, child:
                  Text(widget.title ?? '', style: Styles().textStyles.getTextStyle("widget.title.light.medium.fat"),)
                )
              )
            ),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              Expanded(child:
                Padding(padding: EdgeInsets.only(top: 15, bottom: 7), child:
                  Text(title ?? '', style: Styles().textStyles.getTextStyle('widget.title.dark.large.extra_fat'), semanticsLabel: "",),
                )
              ),
