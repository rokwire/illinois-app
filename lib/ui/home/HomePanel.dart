...
import 'package:illinois/ui/home/HomeStudentGuidePromoWidget.dart';
...
class _HomePanelState extends State<HomePanel> with AutomaticKeepAliveClientMixin<HomePanel> implements NotificationsListener {
  ...
  List<Widget> _buildContentList() {
    ...
    for (String code in _contentListCodes) {
      ...
      else if (code == 'student_guide_promo') {
        widget = HomeStudentGuidePromoWidget(refreshController: _refreshController);
      }
