...
class HomeBusPassWidget extends StatefulWidget {
  HomeBusPassWidget();

  @override
  State<HomeBusPassWidget> createState() => _HomeBusPassWidgetState();
}

class _HomeBusPassWidgetState extends State<HomeBusPassWidget> implements NotificationsListener {
  @override
  void initState() {
                ...
                Container(color: Styles().colors!.fillColorPrimary, child:
                  Padding(padding: EdgeInsets.symmetric(vertical: 8, horizontal: 16), child:
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Expanded(child:
                        Text(Localization().getStringEx('widget.home.bus_pass.title', 'MTD'), style: TextStyle(color: Styles().colors!.white, fontFamily: Styles().fontFamilies!.extraBold, fontSize: 20))
                      ),
                      Row(children: <Widget>[
                    ...
                    Row(children: <Widget>[
                      Expanded(child:
                        VerticalTitleValueSection(
                          ...
                          titleTextStyle: TextStyle(fontFamily: Styles().fontFamilies?.extraBold, fontSize: 24, color: Styles().colors?.fillColorPrimary),
                          value: sprintf(Localization().getStringEx('widget.home.bus_pass.label.card_expires.text', 'Card Expires: %s'), [Auth2().authCard?.expirationDate ?? '']),
