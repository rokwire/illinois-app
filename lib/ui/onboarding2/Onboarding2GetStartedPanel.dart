...
class Onboarding2GetStartedPanel extends StatefulWidget with Onboarding2Panel {
  ...
  Onboarding2GetStartedPanel({ super.key, this.onboardingCode = '', this.onboardingContext });

  _Onboarding2GetStartedPanelState? get _currentState => JsonUtils.cast(globalKey?.currentState);
