...
import 'package:neom/ui/appointments/AppointmentsContentWidget.dart';
import 'package:neom/ui/academics/AcademicsEventsContentWidget.dart';
import 'package:neom/ui/academics/EssentialSkillsCoachDashboardPanel.dart';
import 'package:neom/ui/academics/MedicineCoursesContentWidget.dart';
...
class _AcademicsHomePanelState extends State<AcademicsHomePanel>
  ...
  Widget get _bodyWidget {
    return Column(children: <Widget>[
      ...
      Expanded(child:
        Stack(children: [
          Padding(padding: _skillsSelfEvaluationSelected ? EdgeInsets.zero : (_skillsDashboardSelected ? EdgeInsets.only(top: 16) : EdgeInsets.only(top: 16, left: 16, right: 16,)), child:
            _contentWidget
          ),
