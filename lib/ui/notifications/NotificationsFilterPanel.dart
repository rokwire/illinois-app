...
class _NotificationsFilterPanelState extends State<NotificationsFilterPanel> {
  ...
  FilterEntry? _selectedDateFilter;
        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildDateEntryWidget(
                  ...
                  borderRadius: borderRadius,
                  onTap: () => _onTapTimeFilter(filterEntry),
                  selected: (_selectedDateFilter?.value == filterEntry.value));
            }));
  }
  ...
  void _onTapMuted() {
    //TBD: DD - properly toggle muted value - it is a special case
    setStateIfMounted(() {
  ...
  void _onTapTimeFilter(FilterEntry? filterValue) {
    setStateIfMounted(() {
