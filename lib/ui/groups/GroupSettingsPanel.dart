  ...
  Widget _buildImageSection(){
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          AppString.isStringNotEmpty(_group?.imageURL) ?  Positioned.fill(child:Image.network(_group?.imageURL, fit: BoxFit.cover, headers: Network.authApiKeyHeader,)) : Container(),
          CustomPaint(
