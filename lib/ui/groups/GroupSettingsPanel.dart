  ...
  Widget _buildImageSection(){
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          StringUtils.isNotEmpty(_group?.imageURL) ? Positioned.fill(child: AccessibleImageHolder(child: ModalImageHolder(child: WebNetworkImage(imageUrl: _group?.imageURL, excludeFromSemantics: true, fit: BoxFit.cover, errorBuilder: ImageErrorBuilder.defaultBuilder)))) : Container(),
          CustomPaint(
