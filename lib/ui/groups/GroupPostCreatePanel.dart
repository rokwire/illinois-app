...
class _GroupPostCreatePanelState extends State<GroupPostCreatePanel>{
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
        ...
        body: Stack(alignment: Alignment.topCenter, children: [
          ...
          Column(children: [
            ImageChooserWidget(key: _postImageHolderKey, imageUrl: _postData?.imageUrl, buttonVisible: true , onImageChanged: (url) => _postData.imageUrl = url,),//TBD Use Data model instead of direct post change
            Container(
  ...
  //HTM Utils TBD move to utils class
