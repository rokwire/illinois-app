      ...
      Padding(padding: EdgeInsets.only(top: 16), child:
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Semantics(button: true, excludeSemantics: true,
            label: Localization().getStringEx('panel.group.detail.post.report_abuse.button.policy.label', 'Policy'),
            hint: Localization().getStringEx('panel.group.detail.post.report_abuse.button.policy.hint', 'Tap to ready policy statement'),
