  ...
  Widget _eventImageHeader(){
    ...
    return Container(
      ...
      child:Stack(
        ...
        children: <Widget>[
          StringUtils.isNotEmpty(imageUrl) ?  Positioned.fill(child: AccessibleImageHolder(child: ModalImageHolder(child: WebNetworkImage(imageUrl: imageUrl, fit: BoxFit.cover, excludeFromSemantics: true)))) : Container(),
          CustomPaint(
