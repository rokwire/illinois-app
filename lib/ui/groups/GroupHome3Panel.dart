...
class GroupHome3Panel extends StatefulWidget with AnalyticsInfo {
  static final String routeName = 'edu.illinois.rokwire.group.home3';

  final GroupsFilter? filter;

  GroupHome3Panel({super.key, this.filter});

  static void push(BuildContext context, {GroupsFilter? filter}) =>
      Navigator.push(context, CupertinoPageRoute(
          settings: RouteSettings(name: routeName),
          builder: (context) => GroupHome3Panel(filter: filter,)
      ));

  _GroupHome3PanelState createState() => _GroupHome3PanelState();
...
class _GroupHome3PanelState extends State<GroupHome3Panel> with NotificationsListener {
