    ...
    return StringUtils.isNotEmpty(_group?.imageURL) ?
      Container(height: 200, color: Styles().colors.background, child:
        Stack(alignment: Alignment.bottomCenter, children: <Widget>[
            Positioned.fill(child: AccessibleImageHolder(child: ModalImageHolder(child: WebNetworkImage(imageUrl: _group?.imageURL, excludeFromSemantics: true, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => Container(height: 200, color: Styles().colors.background))))),
...
//OnTap
  ...
  void _onPolicy () {
    ...
    showDialog(context: context, builder: (_) => PointerInterceptor(child: InfoPopup(
