...
//OnTap
  ...
  void _onTapBrowseEvents(){
    ...
    if (_group != null) {
      Event2HomePanel.present(context, eventSelector: GroupEventSelector2(_group!), timeFilter: Event2TimeFilter.upcoming, analyticsFeature: widget.analyticsFeature, upcomingOnly: true);
    }
  }
