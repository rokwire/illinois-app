  ...
  Widget _eventImageHeader(){
    ...
    return Container(
      ...
      child:Stack(
        ...
        children: <Widget>[
          StringUtils.isNotEmpty(imageUrl) ?  Positioned.fill(child: ExpandableNetworkImage(imageUrl ?? '', fit: BoxFit.cover, headers: Config().networkAuthHeaders, excludeFromSemantics: true)) : Container(),
          CustomPaint(
