        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children:<Widget>[
            ...
            Padding(padding: EdgeInsets.only(top: 8), child:
              Text(Localization().getStringEx("panel.membership_request.label.steps.description", 'Share the steps someone will need to take to become a member of your group.'), style: Styles().textStyles.getTextStyle("widget.description.medium.regular.thin")),
            ),
          ]),
      ),
    );
  ...
  Widget _buildStep({required int index}) {
    List<Widget> stepContent = [
      Padding(padding: EdgeInsets.only(bottom: 4),
        child: Text(Localization().getStringEx("panel.membership_request.button.add_steps.step", 'STEP ') +(index+1).toString(), style: Styles().textStyles.getTextStyle("widget.title.dark.tiny")),
      ),
