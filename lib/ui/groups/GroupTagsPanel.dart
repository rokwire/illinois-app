        ...
        SingleChildScrollView(
            child: Padding(padding: EdgeInsets.symmetric(horizontal: 12), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              Padding(padding: EdgeInsets.only(top: 12), child: Row(children: [
                ...
                RoundedButton(label: Localization().getStringEx('panel.group.tags.button.done.title', 'Done')!, mainAxisSize: MainAxisSize.min, textColor: Styles().colors!.fillColorPrimary, borderColor: Styles().colors!.fillColorSecondary, backgroundColor: Styles().colors!.white, onTap: _onTapDone)
              ])),
