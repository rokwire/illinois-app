        ...
        SingleChildScrollView(
            child: Padding(padding: EdgeInsets.symmetric(horizontal: 12), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              Padding(padding: EdgeInsets.only(top: 12), child: Row(children: [
                ...
                RoundedButton(label: Localization().getStringEx('panel.group.tags.button.done.title', 'Done'), textStyle: Styles().textStyles.getTextStyle("widget.button.title.large.fat"), contentWeight: 0.0, borderColor: Styles().colors.fillColorSecondary, backgroundColor: Styles().colors.surface, onTap: _onTapDone)
              ])),
