...
class GroupSurveyListPanel extends StatefulWidget {
  final List<Survey> surveys;
  final Group group;

  GroupSurveyListPanel({required this.surveys, required this.group});

  @override
  _GroupSurveyListPanelState createState() => _GroupSurveyListPanelState();
}

class _GroupSurveyListPanelState extends State<GroupSurveyListPanel> implements NotificationsListener {
