...
class _ExploreMapPanelState extends State<ExploreMapPanel>
          ...
          if (_selectedMapType == ExploreMapType.StoriedSites && _exploreTask == null && _explores != null)
            ExploreStoriedSightsBottomSheet(
              ...
              onPlaceSelected: (places_model.Place place) {
                _onPlaceSelectedFromBottomSheet(place);
              },
              onResetSelection: _onResetSelectionFromBottomSheet,
            ),
  ...
  void _onPlaceSelectedFromBottomSheet(Place place) {
    setState(() {
      _selectionChanged = true;
      _selectedMapExplore = place;
    });
  ...
  void _onResetSelectionFromBottomSheet() {
    setState(() {
      _selectionChanged = true;
  ...
  static String? _exploreItemName(ExploreMapType? exploreItem) {
    switch (exploreItem) {
      ...
      case ExploreMapType.StoriedSites:       return Localization().getStringEx('', 'Storied Sites');
  ...
  static String? _exploreItemHint(ExploreMapType? exploreItem) {
    switch (exploreItem) {
      ...
      case ExploreMapType.StoriedSites:       return Localization().getStringEx('', '');
  ...
  String? get _emptyContentMessage {
    switch (_selectedMapType) {
      ...
      case ExploreMapType.StoriedSites: return Localization().getStringEx('', 'No storied sites are available.');
  ...
  String? get _failedContentMessage {
    switch (_selectedMapType) {
      ...
      case ExploreMapType.StoriedSites: return Localization().getStringEx('', 'Failed to load storied sites.');
  ...
  Future<void> _buildMapContentData(List<Explore>? explores, {Explore? pinnedExplore, bool updateCamera = false, bool showProgress = false, double? zoom}) async {
    ...
    if ((exploresBounds != null) && (mapSize != null)) {
      ...
      if (!DeepCollectionEquality().equals(_exploreMarkerGroups, exploreMarkerGroups) || _selectionChanged) {
