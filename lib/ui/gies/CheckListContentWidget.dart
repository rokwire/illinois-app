...
class _CheckListContentWidgetState extends State<CheckListContentWidget> implements NotificationsListener{
  ...
  Widget _buildTitle() {
    ...
    return Semantics(container: true, child:
      Container(key: _titleKey, color: AppColors.fillColorPrimary, padding: EdgeInsets.only(top: 8, bottom: 8), child:
        Column(children: [
...
class _StepsHorizontalListState extends State<_StepsHorizontalListWidget> implements NotificationsListener{
  ...
  Widget _buildHeader(){
    return Container(padding: EdgeInsets.only(right: 16, left: 16, top: 16,), color: AppColors.fillColorPrimary, child:
