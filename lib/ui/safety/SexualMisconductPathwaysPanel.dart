...
import 'package:illinois/ui/safety/GBVResourceListPanel.dart';
...
class SexualMisconductPathwaysPanel extends StatelessWidget {
  ...
  void _onTalkToSomeone(BuildContext context) {
    // Deserialize GBVResourceListScreen json here, and use result to construct panel
      Navigator.push(context, MaterialPageRoute(builder: (context) => GBVResourceListPanel(resourceListScreen: GBVResourceListScreen(id: 'new List', type: '', title: "My Resource Screen", description: "This is my resource screen."))));
