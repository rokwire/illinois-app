...
class Storage extends rokwire.Storage {
  ...
  static String get notifySettingChanged =>
      rokwire.Storage.notifySettingChanged;
  ...
  factory Storage() => ((rokwire.Storage.instance is Storage) ? (rokwire.Storage
      .instance as Storage) : (rokwire.Storage.instance = Storage.internal()));
  ...
  @override String get reportedUpgradeVersionsKey =>
      'reported_upgrade_versions';
  ...
  IlliniCashBallance? get illiniCashBallance {
    return IlliniCashBallance.fromJson(
        JsonUtils.decodeMap(getEncryptedStringWithName(illiniCashBallanceKey)));
  }

  set illiniCashBallance(IlliniCashBallance? value) {
    setEncryptedStringWithName(illiniCashBallanceKey,
  ...
  String? get selectedTwitterAccount =>
      getStringWithName(selectedTwitterAccountKey);

  set selectedTwitterAccount(String? value) =>
      setStringWithName(selectedTwitterAccountKey, value);
  ...
  set offsetDate(DateTime? value) {
    setStringWithName(offsetDateKey,
        AppDateTime().formatDateTime(value, ignoreTimeZone: true));
  }

  DateTime? get offsetDate {
    String? dateString = getStringWithName(offsetDateKey);
    return StringUtils.isNotEmpty(dateString) ? DateTimeUtils
...
// all subsciptions will be applied again through Notifications BB APIs
  @override String get inboxFirebaseMessagingSubscriptionTopicsKey =>
      'firebase_messaging_subscription_topis';

  @override String get inboxFirebaseMessagingTokenKey =>
      'inbox_firebase_messaging_token';

  @override String get inboxFirebaseMessagingUserIdKey =>
      'inbox_firebase_messaging_user_id';
  ...
  Auth2Token? get auth2UiucToken => Auth2Token.fromJson(
      JsonUtils.decodeMap(getEncryptedStringWithName(auth2UiucTokenKey)));

  set auth2UiucToken(Auth2Token? value) => setEncryptedStringWithName(
      auth2UiucTokenKey, JsonUtils.encode(value?.toJson()));
  ...
  Set<String>? getChecklistCompletedPages(String contentKey) {
    List<String>? pagesList = getStringListWithName(
        "${contentKey}_$_checkListCompletedPagesKey");
  ...
  setChecklistCompletedPages(String contentKey, Set<String>? value) {
    ...
    setStringListWithName(
        "${contentKey}_$_checkListCompletedPagesKey", pagesList);
  }
  ...
  set groupMembersSelection(Map<String, List<List<Member>>>? selection) {
    setStringWithName(
        _groupMemberSelectionTableKey, JsonUtils.encode(selection));
  }

  Map<String, List<List<Member>>>? get groupMembersSelection {
    Map<String, List<List<Member>>> result = Map();
    Map<String, dynamic>? table = JsonUtils.decodeMap(
        getStringWithName(_groupMemberSelectionTableKey));
  ...
  set onCampusRegionId(String? value) =>
      setStringWithName(onCampusRegionIdKey, value);

  String get onCampusRegionMonitorEnabledKey =>
      'edu.illinois.rokwire.on_campus.region_monitor.enabled';

  bool? get onCampusRegionMonitorEnabled =>
      getBoolWithName(onCampusRegionMonitorEnabledKey);

  set onCampusRegionMonitorEnabled(bool? value) =>
      setBoolWithName(onCampusRegionMonitorEnabledKey, value);

  String get onCampusRegionManualInsideKey =>
      'edu.illinois.rokwire.on_campus.region_manual.inside';

  bool? get onCampusRegionManualInside =>
      getBoolWithName(onCampusRegionManualInsideKey);

  set onCampusRegionManualInside(bool? value) =>
      setBoolWithName(onCampusRegionManualInsideKey, value);
  ...
  set homeToutImageUrl(String? value) =>
      setStringWithName(homeToutImageUrlKey, value);

  String get homeToutImageTimeKey =>
      'edu.illinois.rokwire.home.tout.image.time';

  int? get homeToutImageTime => getIntWithName(homeToutImageTimeKey);

  set homeToutImageTime(int? value) =>
      setIntWithName(homeToutImageTimeKey, value);

  // User's Drop Down Selection - Profile, Notifications, Settings, Wellness

  Map<String,
      dynamic>? _userDropDownSelectionMap; // Store it "per app run, not permanent"
  ...
  String get _profileUserDropDownSelectionKey =>
      'user.drop.down.selection.profile';
  ...
  String get _notificationsUserDropDownSelectionKey =>
      'user.drop.down.selection.notifications';
  ...
  set notificationsUserDropDownSelectionValue(String? value) {
    _setUserDropDownSelectionMapValue(
        _notificationsUserDropDownSelectionKey, value);
  }

  String get _settingsUserDropDownSelectionKey =>
      'user.drop.down.selection.settings';
  ...
  String get _wellnessUserDropDownSelectionKey =>
      'user.drop.down.selection.wellness';
