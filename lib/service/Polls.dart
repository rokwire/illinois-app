  ...
  Future<void> create(Poll poll) async {
    if(_enabled) {
      try {
        ...
        Response? response = await Network().post(url, body: json.encode(poll.toJson()), auth: Auth2NetworkAuth());
        int responseCode = response?.statusCode ?? -1;
    ...
    if(_enabled) {
      if (pollId != null) {
        try {
          ...
          Response? response = await Network().put(url, auth: Auth2NetworkAuth());
          if ((response != null) && (response.statusCode == 200)) {
    ...
    if(_enabled) {
      if ((pollId != null) && (vote != null)) {
        try {
          ...
          Response? response = await Network().post(url, body: voteString, auth: Auth2NetworkAuth());
          if ((response != null) && (response.statusCode == 200)) {
