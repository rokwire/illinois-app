...
- WEB: Modifying image [#6032](https://github.com/rokwire/illinois-app/issues/6032).
...
- Make sure to always apply types paramеter in Social.loadConversations call [#5919](https://github.com/rokwire/illinois-app/issues/5919).
### Fixed
...
- Fixed GroupCard overflow exception when displayed inside Home panel widget.
### Added
...
### Fixed
- WEB: set h1 element [#5144](https://github.com/rokwire/illinois-app/issues/5144).
...
- WEB: Fixed sliding bottom sheet in Map2 view.
### Added
...
### Fixed
- WEB: allow drag & drop scrolling using the mouse in sub and recurring events [#4999](https://github.com/rokwire/illinois-app/issues/4999).
...
- WEB: Images disappear from group posts [#5029](https://github.com/rokwire/illinois-app/issues/5029).
- WEB: Images for Past Group Events Do Not Display [#5063](https://github.com/rokwire/illinois-app/issues/5063).
### Changed
...
- Web: load profile picture [#5053](https://github.com/rokwire/illinois-app/issues/5053).
...
### Fixed
- Scanning Qr code in web [#4941](https://github.com/rokwire/illinois-app/issues/4941).
...
- Share My Info for the web app [#4734](https://github.com/rokwire/illinois-app/issues/4734).
### Changed
...
- Showing event image [#4682](https://github.com/rokwire/illinois-app/issues/4682).
### Changed
