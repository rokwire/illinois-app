...
## [0.5.12] = 2025-02-26
### Fixed
- Bug report Feb 26 [#69](https://github.com/rokmetro/neom-app/issues/69)
...
## [0.5.8] = 2025-02-15
### Added
- Add empty favorites widget
- Bold sender name in last conversation messages
### Fixed
- Fix remaining file attachment bugs [#56](https://github.com/rokmetro/neom-app/issues/56)
- Fix user directory entry spacing

## [0.5.7] = 2025-02-14
### Fixed
- Improve file upload UX [#49](https://github.com/rokmetro/neom-app/issues/49)
### Changed
- Improve message file attachment loading [#53](https://github.com/rokmetro/neom-app/issues/53)
...
- Redesign group post creation UI [#33](https://github.com/rokmetro/neom-app/issues/33)
...
## [0.5.0] = 2024-12-21
### Added
- User directory and messages

## [0.4.11] = 2024-11-06
### Fixed
- Fix minor UI issues [#25](https://github.com/rokmetro/neom-app/issues/25)

## [0.4.10] = 2024-11-02
### Fixed
- Fix Groups UI and functionality issues [#21](https://github.com/rokmetro/neom-app/issues/21)
### Changed
- Update Polls UI [#22](https://github.com/rokmetro/neom-app/issues/22)

## [0.4.9] = 2024-10-21
### Changed
- Update group messages UI [#19](https://github.com/rokmetro/neom-app/issues/19)

## [0.4.8] = 2024-10-11
### Changed
- Update Events UI [#15](https://github.com/rokmetro/neom-app/issues/15)
- Update main feed UI [#16](https://github.com/rokmetro/neom-app/issues/16)

## [0.4.7] = 2024-10-02
### Changed
- UI Improvements (add Messages, update GroupDetailsPanel and BrowsePanel) [#8](https://github.com/rokmetro/neom-app/issues/8)
...
### Fixed
- UI Improvements [#8](https://github.com/rokmetro/neom-app/issues/8)

## [0.4.1] - 2024-07-31
### Fixed
- Fix survey display issues [#5](https://github.com/rokmetro/neom-app/issues/5)

## [0.4.0] - 2024-07-26
### Fixed
- Fix styling issues from merge with Illinois
...
- Do not show "Take Attendance" link for events that have no attedance options set [#4994](https://github.com/rokwire/illinois-app/issues/4994).
